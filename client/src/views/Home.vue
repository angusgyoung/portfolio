    ...
    <div v-else>
        <b-row class="mt-5" align-v="center">
          <b-col>
            ...
            <div class="mt-3">
              <a v-for="organisation in organisations" :key="organisation.login" :href="organisation.url">
                <b-img class="org-img m-2" :src="organisation.avatarUrl" :alt="organisation.name" rounded="circle"/>
              </a>
            </div>
          </b-col>
          <b-col>
            <b-img :src="user.avatarUrl" :alt="user.avatarUrl" rounded="circle" fluid/>
          </b-col>
        </b-row>
        <b-row align-h="center" align-v="end" class="fixed-bottom">
            <b-col>
              <div class="d-flex justify-content-center">
                <a :href="user.url"><b-icon class="h2 m-3" icon="github" variant="primary"/></a>
...
export default class Home extends Vue {
  ...
  hireMessage(): string {
    if (this.user.isHireable) {
      return "Available"
    } else return "Currently employed at " + this.user.organization 
  }
}
</script>
